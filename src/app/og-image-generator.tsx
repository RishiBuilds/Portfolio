    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle at 50% 50%, #161233 0%, #070a10 100%)",
          color: "#fff",
          ...
          >
            <h1
              style={{
                ...
                margin: 0,
                background:
                  "linear-gradient(to right, #ffffff 30%, #a855f7 70%, #6366f1 100%)",
                backgroundClip: "text",
                color: "transparent",
                letterSpacing: "-2px",
                lineHeight: 1.1,
            ...
            >
              Specializing in scalable web applications. Designing modern frontend
              interfaces, training custom models, and deploying reliable backends.
            </p>
          </div>
